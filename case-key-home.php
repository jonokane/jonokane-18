...
<section class="folio-pg">
    <div class="container case-study">
        <div class="row">
            <div class="col">
                <h2 class="foliotitle">Case study: Amazon Key In-Home Kit Setup</h2>
                    <hr>
        ...
        <div class="row">
            <div class="col">
                <p>
                    ...
                    <p>The design challenges involved with a "day one" product are, of course, abundant. Through the design journey, divided the work into these main categories:
                        <ul>
